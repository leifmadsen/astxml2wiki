...
This module will convert the XML document produced by Asterisk into
wiki markup consumable by Atlassian Confluence. This includes
checking out the Asterisk source, building the documentation,
parsing it, and pushing the changes directly to a Confluence server.

Copyright (C) 2013, Digium, Inc.
Erin Spiceland <espiceland@digium.com>
Matt Jordan <mjordan@digium.com>

And I'm pretty sure Russell Bryant worked on this as well.
...
class AstXML2Wiki:
    ...
    def update(self):
        ...
        if not self.svndir == 'workdirs/1.8' and not self.svndir == 'workdirs/10':
