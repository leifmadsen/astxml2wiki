...
<!--
Ast(erisk)XML2Wiki Stylesheet

This stylesheet converts the XML documentation into wiki markup.
Note that a pre-processing pass must first be performed by the
python script to handle embedded XML tags in text.
